...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/DFWallet/xec/peer)
...
```bash
$ go get -u github.com/DFWallet/xec/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/DFWallet/xec/peer#example-package--NewOutboundPeer)  
