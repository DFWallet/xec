...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/DFWallet/xec/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/DFWallet/xec/blockchain/fullblocktests
```
